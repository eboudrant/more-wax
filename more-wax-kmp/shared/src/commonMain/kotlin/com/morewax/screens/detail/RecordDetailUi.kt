...
@Composable
fun RecordDetailUi(
    state: RecordDetailScreen.State,
    ...
    Scaffold(
        ...
        when {
            ...
            state.record != null -> {
                RecordContent(state.record, onEvent, Modifier.padding(padding))
            }
        }
...
private fun RecordContent(record: Record, onEvent: (RecordDetailScreen.Event) -> Unit, modifier: Modifier) {
    Column(
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            Text(record.title, style = MaterialTheme.typography.headlineSmall.copy(fontWeight = FontWeight.Bold))
